...
const About = () => {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-20 bg-gradient-to-br from-[#0A2540] to-[#4A90A4] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">About Falcon Ride</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0A2540] mb-4 sm:mb-6">Our Mission</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0A2540] mb-4 sm:mb-6">Our Vision</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A2540] mb-4">Our Values</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">The principles that guide everything we do</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <Card key={index} className="p-5 sm:p-8 text-center hover:shadow-xl transition-all duration-300 border-2 border-gray-100 hover:border-[#4A90A4] group hover:-translate-y-2">
      ...
      {/* Stats Section */}
      <section className="py-12 md:py-20 bg-gradient-to-br from-[#0A2540] to-[#4A90A4] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Falcon Ride by the Numbers</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-200">Making an impact, one ride at a time</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="p-5 sm:p-8 text-center bg-white/10 backdrop-blur-md border-2 border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#D4AF37] mb-2">{stat.number}</div>
      ...
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A2540] mb-4">Our Community</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-5 sm:p-8 border-2 border-[#4A90A4]/20">
